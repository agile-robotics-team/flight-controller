...
void loop() {
  ...
  if(loop_status == 1){
    ...
    esc_1 =  1000 + channels[0] - pid_output_pitch + pid_output_roll;
    esc_2 =  1000 + channels[0] + pid_output_pitch + pid_output_roll;
    esc_3 =  1000 + channels[0] + pid_output_pitch - pid_output_roll;
    esc_4 =  1000 + channels[0] - pid_output_pitch - pid_output_roll; 
